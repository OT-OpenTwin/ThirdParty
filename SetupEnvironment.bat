...
SET QDIR=%OPENTWIN_THIRDPARTY_ROOT%\Qt\6.10.0\msvc2022_64
SET QTVER=6.10.0
SET QTDIR=%QDIR%
SET QT_DIR=%QDIR%
...
REM Set QWT Environment
SET QWT_LIB_ROOT=%OPENTWIN_THIRDPARTY_ROOT%\qwt\qwt-6.2.0
SET QWT_LIB_INC=%QWT_LIB_ROOT%\src
SET QWT_LIB_INCD=%QWT_LIB_INC%
SET QWT_LIB_INCR=%QWT_LIB_INC%
...
SET MONGO_C_ROOT=%OPENTWIN_THIRDPARTY_ROOT%\MongoDb\mongo-c-driver-1.27.3\x64
SET MONGO_C_LIBPATHD=%MONGO_C_ROOT%\Debug\lib
SET MONGO_C_LIBPATHR=%MONGO_C_ROOT%\Release\lib
SET MONGO_C_LIB=bson-1.0.lib;mongoc-1.0.lib
SET MONGO_C_DLLD=%MONGO_C_ROOT%\Debug\bin
SET MONGO_C_DLLR=%MONGO_C_ROOT%\Release\bin

SET MONGO_CXX_ROOT=%OPENTWIN_THIRDPARTY_ROOT%\MongoDb\mongo-cxx-driver-r3.10.0\x64
SET MONGO_CXX_INC=%MONGO_CXX_ROOT%\include
SET MONGO_CXX_LIBPATHD=%MONGO_CXX_ROOT%\Debug\lib
SET MONGO_CXX_LIBPATHR=%MONGO_CXX_ROOT%\Release\lib
SET MONGO_CXX_LIB=bsoncxx.lib;mongocxx.lib
...
SET OT_PYTHON_BIN_NAME=python311
SET OT_CURRENT_PYTHON_PATH=Python\Python3_11_9
SET OT_PYTHON_ROOT=%OPENTWIN_THIRDPARTY_ROOT%\%OT_CURRENT_PYTHON_PATH%
SET OT_PYTHON_INC=%OT_PYTHON_ROOT%\include
SET OT_PYTHON_LIBPATH=%OT_PYTHON_ROOT%\libs
SET OT_PYTHON_BIN=%OT_PYTHON_ROOT%\Interpreter

SET OT_PYTHON_ROOT_LEGACY=%OPENTWIN_THIRDPARTY_ROOT%\Python\python-3.9.5.amd64
SET OT_PYTHON_INC_LEGACY=%OT_PYTHON_ROOT_LEGACY%\include
SET OT_PYTHON_LIBPATH_LEGACY=%OT_PYTHON_ROOT_LEGACY%\libs
SET OT_PYTHONPATH_LEGACY=%OPENTWIN_THIRDPARTY_ROOT%\Python\python-3.9.5.amd64;%OPENTWIN_THIRDPARTY_ROOT%\Python\python-3.9.5.amd64\Scripts

SET PATH=%OT_PYTHONPATH_LEGACY%;%OPENTWIN_THIRDPARTY_ROOT%\doxygen;%PATH%

REM Set Pyrit Directory
SET OT_PYRIT_ROOT=%OPENTWIN_THIRDPARTY_ROOT%\Pyrit
...
SET BOOST_ROOT=%OPENTWIN_THIRDPARTY_ROOT%\boost\boost_1_86_0
SET BOOST_INCD=%BOOST_ROOT%
SET BOOST_INCR=%BOOST_ROOT%
SET BOOST_LIBPATHD=%BOOST_ROOT%\lib64-msvc-14.3
SET BOOST_LIBPATHR=%BOOST_ROOT%\lib64-msvc-14.3
SET BOOST_DLLPATHD=%BOOST_ROOT%\lib64-msvc-14.3
SET BOOST_DLLPATHR=%BOOST_ROOT%\lib64-msvc-14.3
...
REM Set FDTD Directory
SET FDTD_ROOT=%OPENTWIN_THIRDPARTY_ROOT%\openEMS\openEMS_v0.0.36
SET FDTD_INC=%OPENTWIN_THIRDPARTY_ROOT%\openEMS\openEMS_v0.0.36\include
SET FDTD_BIN=%FDTD_ROOT%

REM Set tinyxml2 Directory
Set TINYXML2_ROOT=%OPENTWIN_THIRDPARTY_ROOT%\tinyxml2\tinyxml2-11.0.0
Set TINYXML2_BIN=%TINYXML2_ROOT%

REM Set ELMERFEM Directory
SET ELMERFEM_ROOT=%OPENTWIN_THIRDPARTY_ROOT%\ElmerFEM\9.0
SET ELMERFEM_BIN=%ELMERFEM_ROOT%

REM SET NGSpice Directory
SET NGSPICE_ROOT=%OPENTWIN_THIRDPARTY_ROOT%\mySpice\ngspice-41

REM Set expat directory
SET EXPAT_ROOT=%OPENTWIN_THIRDPARTY_ROOT%\expat\2.8.3
SET EXPAT_INC=%EXPAT_ROOT%\include
SET EXPAT_LIBPATHD=%EXPAT_ROOT%\Bin
SET EXPAT_LIBPATHR=%EXPAT_ROOT%\Bin
SET EXPAT_LIBD=libexpat.lib
SET EXPAT_LIBR=libexpat.lib
SET EXPAT_BIN=%EXPAT_ROOT%\Bin

REM Set mdflib directory
SET MDFLIB_ROOT=%OPENTWIN_THIRDPARTY_ROOT%\mdflib\mdflib-2.3.0
SET MDFLIB_INC=%MDFLIB_ROOT%\include
SET MDFLIB_BIN=%MDFLIB_ROOT%\bin
SET MDFLIB_LIBPATHD=%MDFLIB_ROOT%\lib
SET MDFLIB_LIBPATHR=%MDFLIB_ROOT%\lib
SET MDFLIB_LIBD=mdfd.lib
SET MDFLIB_LIBR=mdf.lib
...
SET MATHJAX_ROOT=%OPENTWIN_THIRDPARTY_ROOT%\MathJax\MathJax-3.2.2\es5
