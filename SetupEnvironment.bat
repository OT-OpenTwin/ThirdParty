...
SET OT_CURRENT_PYTHON_PATH=Python\Python3913
...
SET OT_PYTHON_NUMPY_INC=%OT_PYTHON_ROOT%\Lib\site-packages\numpy\core\include
REM SET OT_PYTHON_NUMPY_LIBPATH=%OT_PYTHON_NUMPY%\lib
