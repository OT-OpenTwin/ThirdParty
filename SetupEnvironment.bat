...
SET QWTPOLAR_LIB_ROOT=%OPENTWIN_THIRDPARTY_ROOT%\qwtpolar\qwtpolar-1.1.1
SET QWTPOLAR_LIB_INCD=%QWTPOLAR_LIB_ROOT%\src
SET QWTPOLAR_LIB_INCR=%QWTPOLAR_LIB_ROOT%\src
SET QWTPOLAR_LIB_LIBD=qwtpolard.lib
SET QWTPOLAR_LIB_LIBR=qwtpolar.lib
SET QWTPOLAR_LIB_LIBPATHD=%QWTPOLAR_LIB_ROOT%\lib
SET QWTPOLAR_LIB_LIBPATHR=%QWTPOLAR_LIB_ROOT%\lib
SET QWTPOLAR_LIB_DLLD=%QWTPOLAR_LIB_ROOT%\lib
SET QWTPOLAR_LIB_DLLR=%QWTPOLAR_LIB_ROOT%\lib
...
SET OC_INCD=%OPENTWIN_THIRDPARTY_ROOT%\inc
...
SET GOOGLE_TEST_INCD=%GOOGLE_TEST_ROOT%\googletest\include
