...
REM SET PYTHON_ROOT=%OPENTWIN_THIRDPARTY_ROOT%\Python\python-3.9.5.amd64
REM SET PYTHONPATH=%OPENTWIN_THIRDPARTY_ROOT%\Python\python-3.9.5.amd64;%OPENTWIN_THIRDPARTY_ROOT%\Python\python-3.9.5.amd64\Scripts
SET PYTHON_ROOT=%OPENTWIN_THIRDPARTY_ROOT%\Python\Python310
