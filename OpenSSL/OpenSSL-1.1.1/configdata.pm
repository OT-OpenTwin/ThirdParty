...
our %config = (
  ...
  MT => "mt",
  MTFLAGS => [ "-nologo" ],
  PERL => "C:\\Strawberry64\\perl\\bin\\perl.exe",
  RANLIB => "ranlib",
  RC => "rc",
  afalgeng => "",
  b32 => "0",
  ...
  openssldir => "C:\\DevSoft\\OpenSSL-1.1.1-pre10-dev-vs2015\\ssl",
  options => "--prefix=C:\\DevSoft\\OpenSSL-1.1.1-pre10-dev-vs2015\\static\\x64\\Debug --openssldir=C:\\DevSoft\\OpenSSL-1.1.1-pre10-dev-vs2015\\ssl --debug no-asan no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-md2 no-msan no-rc5 no-sctp no-shared no-ssl-trace no-ssl3 no-ssl3-method no-ubsan no-unit-test no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
  perl_archname => "MSWin32-x64-multi-thread",
  perl_cmd => "C:\\Strawberry64\\perl\\bin\\perl.exe",
  perl_version => "5.28.0",
  perlargv => [ "VC-WIN64A", "--prefix=C:\\DevSoft\\OpenSSL-1.1.1-pre10-dev-vs2015\\static\\x64\\Debug", "--openssldir=C:\\DevSoft\\OpenSSL-1.1.1-pre10-dev-vs2015\\ssl", "--debug", "no-shared" ],
  perlenv => {
      "AR" => undef,
      "ARFLAGS" => undef,
      "AS" => undef,
  ...
  prefix => "C:\\DevSoft\\OpenSSL-1.1.1-pre10-dev-vs2015\\static\\x64\\Debug",
  processor => "",
  ...
  target => "VC-WIN64A",
  tdirs => [ "ossl_shim" ],
  version => "1.1.1-pre10-dev",
  version_num => "0x1010100aL",
);
