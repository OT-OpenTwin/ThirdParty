QT.insighttracker.VERSION = 6.6.2
QT.insighttracker.name = QtInsightTracker
QT.insighttracker.module = Qt6InsightTracker
QT.insighttracker.libs = $$QT_MODULE_LIB_BASE
QT.insighttracker.ldflags = 
...
QT.insighttracker.depends =  core core_private gui network sql
QT.insighttracker.uses = 
QT.insighttracker.module_config = v2
QT.insighttracker.CONFIG = moc
