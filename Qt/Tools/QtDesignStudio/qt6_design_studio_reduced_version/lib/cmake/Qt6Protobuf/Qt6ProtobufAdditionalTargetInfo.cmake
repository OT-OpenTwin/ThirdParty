...
get_target_property(_qt_imported_location Qt6::Protobuf IMPORTED_LOCATION_RELWITHDEBINFO)
get_target_property(_qt_imported_implib Qt6::Protobuf IMPORTED_IMPLIB_RELWITHDEBINFO)
get_target_property(_qt_imported_location_default Qt6::Protobuf IMPORTED_LOCATION_${QT_DEFAULT_IMPORT_CONFIGURATION})
get_target_property(_qt_imported_implib_default Qt6::Protobuf IMPORTED_IMPLIB_${QT_DEFAULT_IMPORT_CONFIGURATION})
...
if(_qt_imported_location)
    set_property(TARGET Qt6::Protobuf PROPERTY IMPORTED_LOCATION_RELEASE "${_qt_imported_location}")
endif()
if(_qt_imported_implib)
    set_property(TARGET Qt6::Protobuf PROPERTY IMPORTED_IMPLIB_RELEASE "${_qt_imported_implib}")
endif()
...
if(_qt_imported_implib)
    set_property(TARGET Qt6::Protobuf PROPERTY IMPORTED_IMPLIB_MINSIZEREL "${_qt_imported_implib}")
endif()
...
if(_qt_imported_implib_default)
    set_property(TARGET Qt6::Protobuf PROPERTY IMPORTED_IMPLIB "${_qt_imported_implib_default}")
endif()
