...
get_target_property(_qt_imported_location Qt6::Quick3DAssetImport IMPORTED_LOCATION_RELWITHDEBINFO)
get_target_property(_qt_imported_implib Qt6::Quick3DAssetImport IMPORTED_IMPLIB_RELWITHDEBINFO)
...
get_target_property(_qt_imported_implib_default Qt6::Quick3DAssetImport IMPORTED_IMPLIB_${QT_DEFAULT_IMPORT_CONFIGURATION})
...
if(_qt_imported_location)
    set_property(TARGET Qt6::Quick3DAssetImport PROPERTY IMPORTED_LOCATION_RELEASE "${_qt_imported_location}")
endif()
if(_qt_imported_implib)
    set_property(TARGET Qt6::Quick3DAssetImport PROPERTY IMPORTED_IMPLIB_RELEASE "${_qt_imported_implib}")
endif()
...
if(_qt_imported_implib)
    set_property(TARGET Qt6::Quick3DAssetImport PROPERTY IMPORTED_IMPLIB_MINSIZEREL "${_qt_imported_implib}")
endif()
...
if(_qt_imported_implib_default)
    set_property(TARGET Qt6::Quick3DAssetImport PROPERTY IMPORTED_IMPLIB "${_qt_imported_implib_default}")
endif()
