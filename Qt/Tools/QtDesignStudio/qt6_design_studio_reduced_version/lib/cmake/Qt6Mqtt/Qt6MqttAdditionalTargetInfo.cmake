...
get_target_property(_qt_imported_location Qt6::Mqtt IMPORTED_LOCATION_RELWITHDEBINFO)
get_target_property(_qt_imported_implib Qt6::Mqtt IMPORTED_IMPLIB_RELWITHDEBINFO)
...
if(_qt_imported_location)
    set_property(TARGET Qt6::Mqtt PROPERTY IMPORTED_LOCATION_RELEASE "${_qt_imported_location}")
endif()
if(_qt_imported_implib)
    set_property(TARGET Qt6::Mqtt PROPERTY IMPORTED_IMPLIB_RELEASE "${_qt_imported_implib}")
endif()
