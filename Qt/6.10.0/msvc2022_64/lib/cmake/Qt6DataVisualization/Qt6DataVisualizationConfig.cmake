...
set(__qt_DataVisualization_always_load_private_module OFF)
include("${CMAKE_CURRENT_LIST_DIR}/Qt6DataVisualization-build.cmake" OPTIONAL)
if (Qt6DataVisualization_FOUND
        AND NOT Qt6DataVisualizationPrivate_FOUND
        AND NOT FALSE
        AND (
            __qt_DataVisualization_always_load_private_module
    ...
    find_package(Qt6DataVisualizationPrivate "6.10.0" EXACT
        QUIET
        CONFIG
        PATHS
    ...
    if(NOT Qt6DataVisualizationPrivate_FOUND)
        get_property(Qt6DataVisualizationPrivate_warning_shown GLOBAL PROPERTY
            Qt6DataVisualizationPrivate_warning_shown
        )
        if(NOT Qt6DataVisualizationPrivate_warning_shown)
            message(VERBOSE
                "The private module package 'Qt6DataVisualizationPrivate' "
                "could not be found. It possibly needs to be installed separately with your "
                "package manager."
            )
            set_property(GLOBAL PROPERTY
                Qt6DataVisualizationPrivate_warning_shown ON
            )
        endif()
    endif()
endif()
unset(__qt_DataVisualization_always_load_private_module)
...
if (NOT QT_NO_CREATE_TARGETS AND Qt6DataVisualization_FOUND)
    ...
    if(NOT Qt6DataVisualization_DEFINITIONS)
        ...
        set(updated_defs "")
        foreach(def IN LISTS  Qt6DataVisualization_DEFINITIONS)
        ...
        endforeach()
        set(Qt6DataVisualization_DEFINITIONS "${updated_defs}")
        unset(updated_defs)
    endif()
...
if (TARGET Qt6::DataVisualization)
    ...
    if(NOT "DataVisualization" IN_LIST QT_ALL_MODULES_FOUND_VIA_FIND_PACKAGE)
    ...
    if(NOT QT_NO_CREATE_VERSIONLESS_TARGETS)
        if(CMAKE_VERSION VERSION_LESS 3.18 OR QT_USE_OLD_VERSION_LESS_TARGETS)
            ...
            include("${CMAKE_CURRENT_LIST_DIR}/Qt6DataVisualizationVersionlessAliasTargets.cmake")
        endif()
    endif()
else()
