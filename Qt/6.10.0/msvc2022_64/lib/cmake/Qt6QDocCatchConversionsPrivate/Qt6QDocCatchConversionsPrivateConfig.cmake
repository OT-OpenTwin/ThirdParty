...
set(__qt_QDocCatchConversionsPrivate_always_load_private_module OFF)
include("${CMAKE_CURRENT_LIST_DIR}/Qt6QDocCatchConversionsPrivate-build.cmake" OPTIONAL)
if (Qt6QDocCatchConversionsPrivate_FOUND
        AND NOT Qt6QDocCatchConversionsPrivatePrivate_FOUND
        AND NOT TRUE
        AND (
            __qt_QDocCatchConversionsPrivate_always_load_private_module
    ...
    find_package(Qt6QDocCatchConversionsPrivatePrivate "6.10.0" EXACT
        QUIET
        CONFIG
        PATHS
    ...
    if(NOT Qt6QDocCatchConversionsPrivatePrivate_FOUND)
        get_property(Qt6QDocCatchConversionsPrivatePrivate_warning_shown GLOBAL PROPERTY
            Qt6QDocCatchConversionsPrivatePrivate_warning_shown
        )
        if(NOT Qt6QDocCatchConversionsPrivatePrivate_warning_shown)
            message(VERBOSE
                "The private module package 'Qt6QDocCatchConversionsPrivatePrivate' "
                "could not be found. It possibly needs to be installed separately with your "
                "package manager."
            )
            set_property(GLOBAL PROPERTY
                Qt6QDocCatchConversionsPrivatePrivate_warning_shown ON
            )
        endif()
    endif()
endif()
unset(__qt_QDocCatchConversionsPrivate_always_load_private_module)
