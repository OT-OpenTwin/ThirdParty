...
set(__qt_3DExtras_always_load_private_module OFF)
include("${CMAKE_CURRENT_LIST_DIR}/Qt63DExtras-build.cmake" OPTIONAL)
if (Qt63DExtras_FOUND
        AND NOT Qt63DExtrasPrivate_FOUND
        AND NOT FALSE
        AND (
            __qt_3DExtras_always_load_private_module
    ...
    find_package(Qt63DExtrasPrivate "6.10.0" EXACT
        QUIET
        CONFIG
        PATHS
    ...
    if(NOT Qt63DExtrasPrivate_FOUND)
        get_property(Qt63DExtrasPrivate_warning_shown GLOBAL PROPERTY
            Qt63DExtrasPrivate_warning_shown
        )
        if(NOT Qt63DExtrasPrivate_warning_shown)
            message(VERBOSE
                "The private module package 'Qt63DExtrasPrivate' "
                "could not be found. It possibly needs to be installed separately with your "
                "package manager."
            )
            set_property(GLOBAL PROPERTY
                Qt63DExtrasPrivate_warning_shown ON
            )
        endif()
    endif()
endif()
unset(__qt_3DExtras_always_load_private_module)
...
if (NOT QT_NO_CREATE_TARGETS AND Qt63DExtras_FOUND)
    ...
    if(NOT Qt63DExtras_DEFINITIONS)
        ...
        set(updated_defs "")
        foreach(def IN LISTS  Qt63DExtras_DEFINITIONS)
        ...
        endforeach()
        set(Qt63DExtras_DEFINITIONS "${updated_defs}")
        unset(updated_defs)
    endif()
...
if (TARGET Qt6::3DExtras)
    ...
    if(NOT "3DExtras" IN_LIST QT_ALL_MODULES_FOUND_VIA_FIND_PACKAGE)
    ...
    if(NOT QT_NO_CREATE_VERSIONLESS_TARGETS)
        if(CMAKE_VERSION VERSION_LESS 3.18 OR QT_USE_OLD_VERSION_LESS_TARGETS)
            ...
            include("${CMAKE_CURRENT_LIST_DIR}/Qt63DExtrasVersionlessAliasTargets.cmake")
        endif()
    endif()
else()
