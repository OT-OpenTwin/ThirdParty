...
set(__qt_3DInput_always_load_private_module OFF)
include("${CMAKE_CURRENT_LIST_DIR}/Qt63DInput-build.cmake" OPTIONAL)
if (Qt63DInput_FOUND
        AND NOT Qt63DInputPrivate_FOUND
        AND NOT FALSE
        AND (
            __qt_3DInput_always_load_private_module
    ...
    find_package(Qt63DInputPrivate "6.10.0" EXACT
        QUIET
        CONFIG
        PATHS
    ...
    if(NOT Qt63DInputPrivate_FOUND)
        get_property(Qt63DInputPrivate_warning_shown GLOBAL PROPERTY
            Qt63DInputPrivate_warning_shown
        )
        if(NOT Qt63DInputPrivate_warning_shown)
            message(VERBOSE
                "The private module package 'Qt63DInputPrivate' "
                "could not be found. It possibly needs to be installed separately with your "
                "package manager."
            )
            set_property(GLOBAL PROPERTY
                Qt63DInputPrivate_warning_shown ON
            )
        endif()
    endif()
endif()
unset(__qt_3DInput_always_load_private_module)
...
if (TARGET Qt6::3DInput)
    ...
    if(NOT "3DInput" IN_LIST QT_ALL_MODULES_FOUND_VIA_FIND_PACKAGE)
