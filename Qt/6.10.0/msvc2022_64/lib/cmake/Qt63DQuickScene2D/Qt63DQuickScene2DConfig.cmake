...
set(__qt_3DQuickScene2D_always_load_private_module OFF)
include("${CMAKE_CURRENT_LIST_DIR}/Qt63DQuickScene2D-build.cmake" OPTIONAL)
if (Qt63DQuickScene2D_FOUND
        AND NOT Qt63DQuickScene2DPrivate_FOUND
        AND NOT FALSE
        AND (
            __qt_3DQuickScene2D_always_load_private_module
    ...
    find_package(Qt63DQuickScene2DPrivate "6.10.0" EXACT
        QUIET
        CONFIG
        PATHS
    ...
    if(NOT Qt63DQuickScene2DPrivate_FOUND)
        get_property(Qt63DQuickScene2DPrivate_warning_shown GLOBAL PROPERTY
            Qt63DQuickScene2DPrivate_warning_shown
        )
        if(NOT Qt63DQuickScene2DPrivate_warning_shown)
            message(VERBOSE
                "The private module package 'Qt63DQuickScene2DPrivate' "
                "could not be found. It possibly needs to be installed separately with your "
                "package manager."
            )
            set_property(GLOBAL PROPERTY
                Qt63DQuickScene2DPrivate_warning_shown ON
            )
        endif()
    endif()
endif()
unset(__qt_3DQuickScene2D_always_load_private_module)
...
if (NOT QT_NO_CREATE_TARGETS AND Qt63DQuickScene2D_FOUND)
    ...
    if(NOT Qt63DQuickScene2D_DEFINITIONS)
        ...
        set(updated_defs "")
        foreach(def IN LISTS  Qt63DQuickScene2D_DEFINITIONS)
        ...
        endforeach()
        set(Qt63DQuickScene2D_DEFINITIONS "${updated_defs}")
        unset(updated_defs)
    endif()
    ...
    foreach(_module_dep ${_Qt63DQuickScene2D_MODULE_DEPENDENCIES})
        ...
        list(APPEND Qt63DQuickScene2D${_private_suffix}_INCLUDE_DIRS
             ${Qt6${_module_dep}_INCLUDE_DIRS})
        list(APPEND Qt63DQuickScene2D${_private_suffix}_PRIVATE_INCLUDE_DIRS
             ${Qt6${_module_dep}_PRIVATE_INCLUDE_DIRS})
        if(_private_suffix)
            list(APPEND Qt63DQuickScene2D_PRIVATE_INCLUDE_DIRS
                ${Qt6${_module_dep}_PRIVATE_INCLUDE_DIRS})
        endif()
        list(APPEND Qt63DQuickScene2D${_private_suffix}_DEFINITIONS
             ${Qt6${_module_dep}_DEFINITIONS})
        list(APPEND Qt63DQuickScene2D${_private_suffix}_COMPILE_DEFINITIONS
...
if (TARGET Qt6::3DQuickScene2D)
    ...
    if(NOT "3DQuickScene2D" IN_LIST QT_ALL_MODULES_FOUND_VIA_FIND_PACKAGE)
    ...
    if(NOT QT_NO_CREATE_VERSIONLESS_TARGETS)
        if(CMAKE_VERSION VERSION_LESS 3.18 OR QT_USE_OLD_VERSION_LESS_TARGETS)
            ...
            include("${CMAKE_CURRENT_LIST_DIR}/Qt63DQuickScene2DVersionlessAliasTargets.cmake")
        endif()
    endif()
else()
