...
set(__qt_3DLogic_always_load_private_module OFF)
include("${CMAKE_CURRENT_LIST_DIR}/Qt63DLogic-build.cmake" OPTIONAL)
if (Qt63DLogic_FOUND
        AND NOT Qt63DLogicPrivate_FOUND
        AND NOT FALSE
        AND (
            __qt_3DLogic_always_load_private_module
    ...
    find_package(Qt63DLogicPrivate "6.10.0" EXACT
        QUIET
        CONFIG
        PATHS
    ...
    if(NOT Qt63DLogicPrivate_FOUND)
        get_property(Qt63DLogicPrivate_warning_shown GLOBAL PROPERTY
            Qt63DLogicPrivate_warning_shown
        )
        if(NOT Qt63DLogicPrivate_warning_shown)
            message(VERBOSE
                "The private module package 'Qt63DLogicPrivate' "
                "could not be found. It possibly needs to be installed separately with your "
                "package manager."
            )
            set_property(GLOBAL PROPERTY
                Qt63DLogicPrivate_warning_shown ON
            )
        endif()
    endif()
endif()
unset(__qt_3DLogic_always_load_private_module)
...
if (TARGET Qt6::3DLogic)
    ...
    if(NOT "3DLogic" IN_LIST QT_ALL_MODULES_FOUND_VIA_FIND_PACKAGE)
