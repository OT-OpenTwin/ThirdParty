...
if (NOT QT_NO_CREATE_TARGETS)
    ...
    if(EXISTS "${CMAKE_CURRENT_LIST_DIR}/Qt6QWindowsIntegrationPluginDependencies.cmake")
        include("${CMAKE_CURRENT_LIST_DIR}/Qt6QWindowsIntegrationPluginDependencies.cmake")
    else()
        set(QWindowsIntegrationPlugin_FOUND TRUE)
    endif()

    if(QWindowsIntegrationPlugin_FOUND)
        include("${CMAKE_CURRENT_LIST_DIR}/Qt6QWindowsIntegrationPluginTargets.cmake")
        include("${CMAKE_CURRENT_LIST_DIR}/Qt6QWindowsIntegrationPluginAdditionalTargetInfo.cmake")
    endif()
endif()
