...
get_target_property(_qt_imported_implib Qt6::LabsSettings IMPORTED_IMPLIB_RELWITHDEBINFO)
get_target_property(_qt_imported_link_dependencies Qt6::LabsSettings IMPORTED_LINK_DEPENDENT_LIBRARIES_RELWITHDEBINFO)
...
get_target_property(_qt_imported_link_dependencies_default Qt6::LabsSettings IMPORTED_LINK_DEPENDENT_LIBRARIES_${QT_DEFAULT_IMPORT_CONFIGURATION})
...
if(_qt_imported_implib)
    set_property(TARGET Qt6::LabsSettings PROPERTY IMPORTED_IMPLIB_RELEASE "${_qt_imported_implib}")
endif()
if(_qt_imported_link_dependencies)
    set_property(TARGET Qt6::LabsSettings PROPERTY IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "${_qt_imported_link_dependencies}")
endif()
...
if(_qt_imported_link_dependencies)
    set_property(TARGET Qt6::LabsSettings PROPERTY IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "${_qt_imported_link_dependencies}")
endif()
...
if(_qt_imported_link_dependencies_default)
    set_property(TARGET Qt6::LabsSettings PROPERTY IMPORTED_LINK_DEPENDENT_LIBRARIES "${_qt_imported_link_dependencies_default}")
endif()
