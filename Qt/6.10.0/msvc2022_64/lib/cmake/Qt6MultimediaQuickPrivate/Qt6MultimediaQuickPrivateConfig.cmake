...
set(__qt_MultimediaQuickPrivate_always_load_private_module OFF)
include("${CMAKE_CURRENT_LIST_DIR}/Qt6MultimediaQuickPrivate-build.cmake" OPTIONAL)
if (Qt6MultimediaQuickPrivate_FOUND
        AND NOT Qt6MultimediaQuickPrivatePrivate_FOUND
        AND NOT TRUE
        AND (
            __qt_MultimediaQuickPrivate_always_load_private_module
    ...
    find_package(Qt6MultimediaQuickPrivatePrivate "6.10.0" EXACT
        QUIET
        CONFIG
        PATHS
    ...
    if(NOT Qt6MultimediaQuickPrivatePrivate_FOUND)
        get_property(Qt6MultimediaQuickPrivatePrivate_warning_shown GLOBAL PROPERTY
            Qt6MultimediaQuickPrivatePrivate_warning_shown
        )
        if(NOT Qt6MultimediaQuickPrivatePrivate_warning_shown)
            message(VERBOSE
                "The private module package 'Qt6MultimediaQuickPrivatePrivate' "
                "could not be found. It possibly needs to be installed separately with your "
                "package manager."
            )
            set_property(GLOBAL PROPERTY
                Qt6MultimediaQuickPrivatePrivate_warning_shown ON
            )
        endif()
    endif()
endif()
unset(__qt_MultimediaQuickPrivate_always_load_private_module)
...
if (NOT QT_NO_CREATE_TARGETS AND Qt6MultimediaQuickPrivate_FOUND)
    ...
    if(NOT Qt6MultimediaQuickPrivate_DEFINITIONS)
        ...
        set(updated_defs "")
        foreach(def IN LISTS  Qt6MultimediaQuickPrivate_DEFINITIONS)
        ...
        endforeach()
        set(Qt6MultimediaQuickPrivate_DEFINITIONS "${updated_defs}")
        unset(updated_defs)
    endif()
...
if (TARGET Qt6::MultimediaQuickPrivate)
    ...
    if(NOT "MultimediaQuickPrivate" IN_LIST QT_ALL_MODULES_FOUND_VIA_FIND_PACKAGE)
    ...
    if(NOT QT_NO_CREATE_VERSIONLESS_TARGETS)
        if(CMAKE_VERSION VERSION_LESS 3.18 OR QT_USE_OLD_VERSION_LESS_TARGETS)
            ...
            include("${CMAKE_CURRENT_LIST_DIR}/Qt6MultimediaQuickPrivateVersionlessAliasTargets.cmake")
        endif()
    endif()
else()
