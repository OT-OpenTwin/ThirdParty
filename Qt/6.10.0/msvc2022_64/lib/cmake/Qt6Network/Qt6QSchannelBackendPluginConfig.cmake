...
if (NOT QT_NO_CREATE_TARGETS)
    ...
    if(EXISTS "${CMAKE_CURRENT_LIST_DIR}/Qt6QSchannelBackendPluginDependencies.cmake")
        include("${CMAKE_CURRENT_LIST_DIR}/Qt6QSchannelBackendPluginDependencies.cmake")
    else()
        set(QSchannelBackendPlugin_FOUND TRUE)
    endif()

    if(QSchannelBackendPlugin_FOUND)
        include("${CMAKE_CURRENT_LIST_DIR}/Qt6QSchannelBackendPluginTargets.cmake")
        include("${CMAKE_CURRENT_LIST_DIR}/Qt6QSchannelBackendPluginAdditionalTargetInfo.cmake")
    endif()
endif()
