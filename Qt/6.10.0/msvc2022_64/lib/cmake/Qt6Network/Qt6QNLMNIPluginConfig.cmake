...
if (NOT QT_NO_CREATE_TARGETS)
    ...
    if(EXISTS "${CMAKE_CURRENT_LIST_DIR}/Qt6QNLMNIPluginDependencies.cmake")
        include("${CMAKE_CURRENT_LIST_DIR}/Qt6QNLMNIPluginDependencies.cmake")
    else()
        set(QNLMNIPlugin_FOUND TRUE)
    endif()

    if(QNLMNIPlugin_FOUND)
        include("${CMAKE_CURRENT_LIST_DIR}/Qt6QNLMNIPluginTargets.cmake")
        include("${CMAKE_CURRENT_LIST_DIR}/Qt6QNLMNIPluginAdditionalTargetInfo.cmake")
    endif()
endif()
