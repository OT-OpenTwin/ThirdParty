...
get_target_property(_qt_imported_implib Qt6::Sql IMPORTED_IMPLIB_RELWITHDEBINFO)
get_target_property(_qt_imported_link_dependencies Qt6::Sql IMPORTED_LINK_DEPENDENT_LIBRARIES_RELWITHDEBINFO)
...
if(_qt_imported_implib)
    set_property(TARGET Qt6::Sql PROPERTY IMPORTED_IMPLIB_RELEASE "${_qt_imported_implib}")
endif()
if(_qt_imported_link_dependencies)
    set_property(TARGET Qt6::Sql PROPERTY IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "${_qt_imported_link_dependencies}")
endif()
