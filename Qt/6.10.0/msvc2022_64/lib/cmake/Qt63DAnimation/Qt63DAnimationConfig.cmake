...
set(__qt_3DAnimation_always_load_private_module OFF)
include("${CMAKE_CURRENT_LIST_DIR}/Qt63DAnimation-build.cmake" OPTIONAL)
if (Qt63DAnimation_FOUND
        AND NOT Qt63DAnimationPrivate_FOUND
        AND NOT FALSE
        AND (
            __qt_3DAnimation_always_load_private_module
    ...
    find_package(Qt63DAnimationPrivate "6.10.0" EXACT
        QUIET
        CONFIG
        PATHS
    ...
    if(NOT Qt63DAnimationPrivate_FOUND)
        get_property(Qt63DAnimationPrivate_warning_shown GLOBAL PROPERTY
            Qt63DAnimationPrivate_warning_shown
        )
        if(NOT Qt63DAnimationPrivate_warning_shown)
            message(VERBOSE
                "The private module package 'Qt63DAnimationPrivate' "
                "could not be found. It possibly needs to be installed separately with your "
                "package manager."
            )
            set_property(GLOBAL PROPERTY
                Qt63DAnimationPrivate_warning_shown ON
            )
        endif()
    endif()
endif()
unset(__qt_3DAnimation_always_load_private_module)
...
if (NOT QT_NO_CREATE_TARGETS AND Qt63DAnimation_FOUND)
    ...
    if(NOT Qt63DAnimation_DEFINITIONS)
        ...
        set(updated_defs "")
        foreach(def IN LISTS  Qt63DAnimation_DEFINITIONS)
        ...
        endforeach()
        set(Qt63DAnimation_DEFINITIONS "${updated_defs}")
        unset(updated_defs)
    endif()
...
if (TARGET Qt6::3DAnimation)
    ...
    if(NOT "3DAnimation" IN_LIST QT_ALL_MODULES_FOUND_VIA_FIND_PACKAGE)
    ...
    if(NOT QT_NO_CREATE_VERSIONLESS_TARGETS)
        if(CMAKE_VERSION VERSION_LESS 3.18 OR QT_USE_OLD_VERSION_LESS_TARGETS)
            ...
            include("${CMAKE_CURRENT_LIST_DIR}/Qt63DAnimationVersionlessAliasTargets.cmake")
        endif()
    endif()
else()
