...
set(__qt_Multimedia_always_load_private_module OFF)
include("${CMAKE_CURRENT_LIST_DIR}/Qt6Multimedia-build.cmake" OPTIONAL)
if (Qt6Multimedia_FOUND
        AND NOT Qt6MultimediaPrivate_FOUND
        AND NOT FALSE
        AND (
            __qt_Multimedia_always_load_private_module
    ...
    find_package(Qt6MultimediaPrivate "6.10.0" EXACT
        QUIET
        CONFIG
        PATHS
    ...
    if(NOT Qt6MultimediaPrivate_FOUND)
        get_property(Qt6MultimediaPrivate_warning_shown GLOBAL PROPERTY
            Qt6MultimediaPrivate_warning_shown
        )
        if(NOT Qt6MultimediaPrivate_warning_shown)
            message(VERBOSE
                "The private module package 'Qt6MultimediaPrivate' "
                "could not be found. It possibly needs to be installed separately with your "
                "package manager."
            )
            set_property(GLOBAL PROPERTY
                Qt6MultimediaPrivate_warning_shown ON
            )
        endif()
    endif()
endif()
unset(__qt_Multimedia_always_load_private_module)
...
if (NOT QT_NO_CREATE_TARGETS AND Qt6Multimedia_FOUND)
    ...
    if(NOT Qt6Multimedia_DEFINITIONS)
        ...
        set(updated_defs "")
        foreach(def IN LISTS  Qt6Multimedia_DEFINITIONS)
        ...
        endforeach()
        set(Qt6Multimedia_DEFINITIONS "${updated_defs}")
        unset(updated_defs)
    endif()
...
if (TARGET Qt6::Multimedia)
    ...
    foreach(extra_cmake_include Qt6MultimediaMacros.cmake)
    ...
    if(NOT "Multimedia" IN_LIST QT_ALL_MODULES_FOUND_VIA_FIND_PACKAGE)
    ...
    if(NOT QT_NO_CREATE_VERSIONLESS_TARGETS)
        if(CMAKE_VERSION VERSION_LESS 3.18 OR QT_USE_OLD_VERSION_LESS_TARGETS)
            ...
            include("${CMAKE_CURRENT_LIST_DIR}/Qt6MultimediaVersionlessAliasTargets.cmake")
        endif()
    endif()
else()
