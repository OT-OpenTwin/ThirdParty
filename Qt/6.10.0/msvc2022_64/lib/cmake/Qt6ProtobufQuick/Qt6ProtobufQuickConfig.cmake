...
set(__qt_ProtobufQuick_always_load_private_module OFF)
include("${CMAKE_CURRENT_LIST_DIR}/Qt6ProtobufQuick-build.cmake" OPTIONAL)
if (Qt6ProtobufQuick_FOUND
        AND NOT Qt6ProtobufQuickPrivate_FOUND
        AND NOT FALSE
        AND (
            __qt_ProtobufQuick_always_load_private_module
    ...
    find_package(Qt6ProtobufQuickPrivate "6.10.0" EXACT
        QUIET
        CONFIG
        PATHS
    ...
    if(NOT Qt6ProtobufQuickPrivate_FOUND)
        get_property(Qt6ProtobufQuickPrivate_warning_shown GLOBAL PROPERTY
            Qt6ProtobufQuickPrivate_warning_shown
        )
        if(NOT Qt6ProtobufQuickPrivate_warning_shown)
            message(VERBOSE
                "The private module package 'Qt6ProtobufQuickPrivate' "
                "could not be found. It possibly needs to be installed separately with your "
                "package manager."
            )
            set_property(GLOBAL PROPERTY
                Qt6ProtobufQuickPrivate_warning_shown ON
            )
        endif()
    endif()
endif()
unset(__qt_ProtobufQuick_always_load_private_module)
...
if (TARGET Qt6::ProtobufQuick)
    ...
    if(NOT "ProtobufQuick" IN_LIST QT_ALL_MODULES_FOUND_VIA_FIND_PACKAGE)
