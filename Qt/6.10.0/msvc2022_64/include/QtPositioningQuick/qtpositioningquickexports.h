...
#include <QtCore/qtconfigmacros.h> // Q_POSITIONINGQUICK_EXPORT
...
#  define QT_POSITIONINGQUICK_CONSTEXPR_INLINE_SINCE(major, minor) constexpr
...
#  define QT_POSITIONINGQUICK_CONSTEXPR_INLINE_SINCE(major, minor) \
