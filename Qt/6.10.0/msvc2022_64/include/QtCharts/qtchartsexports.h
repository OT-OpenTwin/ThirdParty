...
#include <QtCore/qtconfigmacros.h> // Q_CHARTS_EXPORT
...
#  define QT_CHARTS_CONSTEXPR_INLINE_SINCE(major, minor) constexpr
...
#  define QT_CHARTS_CONSTEXPR_INLINE_SINCE(major, minor) \
