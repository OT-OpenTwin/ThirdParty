...
class DiffConductivityParameter(MatProperty):
    r"""Class that represents the derivative of the conductivity to a set of design parameters."""
    ...
    def __init__(self, value: Dict[str, Any], name: str = '', parameter_key: str = None, data: np.ndarray = None):
        ...
        if isinstance(value, (float, int)):
            ...
            if parameter_key is None:
                item = value.popitem()
                value[item[0]] = item[1]  # Add popped item back to value dictionary
