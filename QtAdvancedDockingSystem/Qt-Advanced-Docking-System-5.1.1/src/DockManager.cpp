...
bool DockManagerPrivate::restoreContainer(int Index, CDockingStateReader& stream, bool Testing)
{
	...
	{
		CFloatingDockContainer* FloatingWidget = CComponentsFactory::factory()->createFloatingDockContainer(_this);
...
CFloatingDockContainer* CDockManager::addDockWidgetFloating(CDockWidget* Dockwidget)
{
	...
	CFloatingDockContainer* FloatingWidget = CComponentsFactory::factory()->createFloatingDockContainer(Dockwidget);
