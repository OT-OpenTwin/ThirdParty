...
echo Removing file lib\cmake\libbsoncxx-3.6.6\libbsoncxx-config.cmake
del lib\cmake\libbsoncxx-3.6.6\libbsoncxx-config.cmake || echo ... not removed
echo Removing file lib\cmake\libbsoncxx-3.6.6\libbsoncxx-config-version.cmake
del lib\cmake\libbsoncxx-3.6.6\libbsoncxx-config-version.cmake || echo ... not removed
...
echo Removing file lib\cmake\bsoncxx-3.6.6\bsoncxx_targets.cmake
del lib\cmake\bsoncxx-3.6.6\bsoncxx_targets.cmake || echo ... not removed
echo Removing file lib\cmake\bsoncxx-3.6.6\bsoncxx_targets-release.cmake
del lib\cmake\bsoncxx-3.6.6\bsoncxx_targets-release.cmake || echo ... not removed
echo Removing file lib\cmake\bsoncxx-3.6.6\bsoncxx-config-version.cmake
del lib\cmake\bsoncxx-3.6.6\bsoncxx-config-version.cmake || echo ... not removed
echo Removing file lib\cmake\bsoncxx-3.6.6\bsoncxx-config.cmake
del lib\cmake\bsoncxx-3.6.6\bsoncxx-config.cmake || echo ... not removed
...
echo Removing file lib\cmake\libmongocxx-3.6.6\libmongocxx-config.cmake
del lib\cmake\libmongocxx-3.6.6\libmongocxx-config.cmake || echo ... not removed
echo Removing file lib\cmake\libmongocxx-3.6.6\libmongocxx-config-version.cmake
del lib\cmake\libmongocxx-3.6.6\libmongocxx-config-version.cmake || echo ... not removed
...
echo Removing file lib\cmake\mongocxx-3.6.6\mongocxx_targets.cmake
del lib\cmake\mongocxx-3.6.6\mongocxx_targets.cmake || echo ... not removed
echo Removing file lib\cmake\mongocxx-3.6.6\mongocxx_targets-release.cmake
del lib\cmake\mongocxx-3.6.6\mongocxx_targets-release.cmake || echo ... not removed
echo Removing file lib\cmake\mongocxx-3.6.6\mongocxx-config-version.cmake
del lib\cmake\mongocxx-3.6.6\mongocxx-config-version.cmake || echo ... not removed
echo Removing file lib\cmake\mongocxx-3.6.6\mongocxx-config.cmake
del lib\cmake\mongocxx-3.6.6\mongocxx-config.cmake || echo ... not removed
...
echo Removing directory lib\cmake\bsoncxx-3.6.6
(rmdir lib\cmake\bsoncxx-3.6.6 2>NUL) || echo ... not removed (probably not empty)
echo Removing directory lib\cmake\libbsoncxx-3.6.6
(rmdir lib\cmake\libbsoncxx-3.6.6 2>NUL) || echo ... not removed (probably not empty)
echo Removing directory lib\cmake\libmongocxx-3.6.6
(rmdir lib\cmake\libmongocxx-3.6.6 2>NUL) || echo ... not removed (probably not empty)
echo Removing directory lib\cmake\mongocxx-3.6.6
(rmdir lib\cmake\mongocxx-3.6.6 2>NUL) || echo ... not removed (probably not empty)
